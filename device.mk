...
PRODUCT_LOCALES := en_US pt_PT mdpi
...
# Init
#device/$(MANUFACTURER)/$(DEVICE)/root/init.u8510.usb.rc:root/init.u8510.usb.rc \
#device/$(MANUFACTURER)/$(DEVICE)/root/init.rc:root/init.rc \
PRODUCT_COPY_FILES += \
    device/$(MANUFACTURER)/$(DEVICE)/root/init.huawei.rc:root/init.huawei.rc \
	device/$(MANUFACTURER)/$(DEVICE)/root/default.prop:root/default.prop \
...
PRODUCT_COPY_FILES += \
	...
	device/$(MANUFACTURER)/$(DEVICE)/prebuild/lib/egl/eglsubAndroid.so:system/lib/egl/eglsubAndroid.so \
    device/$(MANUFACTURER)/$(DEVICE)/prebuild/lib/libgsl.so:system/lib/libgsl.so \
	device/$(MANUFACTURER)/$(DEVICE)/prebuild/lib/libsc-a2xx.so:system/lib/libsc-a2xx.so \
