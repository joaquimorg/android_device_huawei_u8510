##
##  . build/envsetup.sh && brunch cyanogen_u8510-eng CYANOGEN_WITH_GOOGLE=true CYANOGEN_NIGHTLY=false CYANOGEN_RELEASE=false
##
...
# apns-conf.xml
#PRODUCT_COPY_FILES += \
#    device/$(MANUFACTURER)/$(DEVICE)/etc/apns-conf_pt.xml:system/etc/apns-conf.xml

PRODUCT_COPY_FILES += \
    device/$(MANUFACTURER)/$(DEVICE)/etc/sysctl.conf:system/etc/sysctl.conf

PRODUCT_COPY_FILES += \
    device/$(MANUFACTURER)/$(DEVICE)/etc/vold.conf:system/etc/vold.conf
...
PRODUCT_COPY_FILES += \
    device/$(MANUFACTURER)/$(DEVICE)/CHANGELOG.mkdn:system/etc/CHANGELOG-CM.txt
